...
# docker build -t planmyday .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name planmyday planmyday
...
# Copy package files for JavaScript dependencies
