module AnnouncementsHelper
  def render_announcement_icon(icon_name)
    icons = {
      ...
      "flag" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"></path>',
    ...
    icon_path = icons[icon_name] || icons["sparkles"]
    %(<svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">#{icon_path}</svg>).html_safe
  end
end
